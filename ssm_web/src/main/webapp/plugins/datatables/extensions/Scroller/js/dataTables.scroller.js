...
Scroller.prototype = /** @lends Scroller.prototype */{
	 ...
	 *  @param {int} [virtual=false] Perform the calculations in the virtual dao
	...
	/**
	 * Convert from one dao to another. The physical dao is the actual
	 ...
	 * only to that maximum value and virtual / physical dao transforms will
